...
namespace MarioRemake
{
    ...
    public partial class World12 : Form
    {
        public World12()
        {
            InitializeComponent();
        ...
        bool marioGn2 = false;
        bool marioGn3 = false;
        bool gumbaGn = false; //För gumba1 resternade är för gumba 2,3,4
        bool gumbaGn2 = false;
        bool gumbaGn3 = false;
        bool gumbaGn4 = false;
        bool mushroomGn = false;
        bool mushroom = false; //om man är stora mario
        bool neripipe = false; //Kollar om man klickar att man vill ner i en pipe
        ...
        private void reset(bool x)
        {
            ...
            World12 frm5 = new World12();
            LoadingScreen frm2 = new LoadingScreen();
            WorldSelector frm3 = new WorldSelector();
            frm5.FormBorderStyle = FormBorderStyle.None;
            frm5.Bounds = Screen.PrimaryScreen.Bounds;
        ...
        //funktionen är inte aktiverad då den var buggig
        ...
        private void World12_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void World12_KeyUp(object sender, KeyEventArgs e)
        {
        ...
        private void timer3_Tick(object sender, EventArgs e)
        {
            ...
            //Hastighetena variablar för data
            totalMarioRörelse += Hastigheten;
            ...
            lbl_Lifes.Text = World11.Life.ToString();
            TicksEfterHopp--;
        }
        ...
        private void World12_Load(object sender, EventArgs e)
        {
