...
namespace MarioRemake
{
    public partial class WorldSelector : Form
    {
        ...
        //Meny listan och allt som visas där Bara enkla messangeboxes.
        ...
        private void WorldSelector_Load(object sender, EventArgs e)
        {
            ...
            lblliv.Text = World11.Life.ToString();
        ...
        {
            MessageBox.Show("The Goal of the game is to survive though out the entire game and beat the final gumbaso");
        }
