...
namespace MarioRemake
{
    ...
    public partial class World13 : Form
    {
        public World13()
        {
            InitializeComponent();
        ...
        bool marioGn2 = false;
        bool marioGn3 = false;
        bool gumbaGn = false; // För gumba1 resterande är gumba2,3,4
        bool gumbaGn2 = false;
        bool gumbaGn3 = false;
        bool gumbaGn4 = false;
        ...
        private void reset(bool x)
        {
            ...
            World13 frm6 = new World13();
            LoadingScreen frm2 = new LoadingScreen();
            WorldSelector frm3 = new WorldSelector();
            frm6.FormBorderStyle = FormBorderStyle.None;
            frm6.Bounds = Screen.PrimaryScreen.Bounds;
        ...
        //Funktionen är buggig och därför deaktiverad
        ...
        private void World13_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void World13_KeyUp(object sender, KeyEventArgs e)
        {
