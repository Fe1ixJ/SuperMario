...
namespace MarioRemake
{
    ...
    public partial class World14 : Form
    {
        public World14() //world 1-4
        {
            InitializeComponent();
        }
        ...
        private void timer3_Tick_1(object sender, EventArgs e)
        {
            ...
            Gumba4.Top += GumbaGravity3;
            Gumba4.Left += Gumbarörelse3;

            Gumba3.Top += GumbaGravity4;
            Gumba3.Left += Gumbarörelse4;
        ...
        private void reset(bool x)
        {
            ...
            World14 frm7 = new World14();
            LoadingScreen frm2 = new LoadingScreen();
            WorldSelector frm3 = new WorldSelector();
            frm7.FormBorderStyle = FormBorderStyle.None;
            frm7.Bounds = Screen.PrimaryScreen.Bounds;
        ...
        private void World14_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void World14_KeyUp(object sender, KeyEventArgs e)
        {
        ...
        private void Gumba2_Click(object sender, EventArgs e)
        {

        }

        private void World14_Load(object sender, EventArgs e)
        {
